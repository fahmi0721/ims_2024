<?php
    ...
    function DetailData($data){
        ...
        if(is_array($data)){
            ...
            $sql = "SELECT a.File, a.Id, a.NoKtp, a.NoDokumen, a.KodeCabang, a.KodeDivisi, a.KodeSubDivisi, a.KodeSeksi, a.TanggalSelesai, a.TanggalMulai, a.Keterangan, b.Nama FROM ims_sk_pengangkatan a INNER JOIN ims_master_tenaga_kerja b ON a.NoKtp = b.NoKtp WHERE Kategori = '0' AND Status = 'pkwt' $FilterSearch";
            $query = $db->query($sql);
