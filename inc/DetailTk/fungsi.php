<?php
    function LoadSertifikatName($NoKtp){
        $sql = "SELECT b.Nama FROM ims_pendidikan_nonformal a INNER JOIN ims_master_pendidikan_nonformal b ON a.KodeMaster = b.Kode WHERE NoKtp = '".$NoKtp."'";
    ...
    function Biodata($NoKtp){
        ...
        $res['Biodata']['StatusKawin'] = getAgama($res['Biodata']['Agama']);
