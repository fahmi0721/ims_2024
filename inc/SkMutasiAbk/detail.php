        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Nama Kapal <span class='text-danger'>*</span></label>
                            <select class='form-control FormInput select-divisi' name='NamaKapal' id='NamaKapal'></select>
                        </div>
                        <div class='col-sm-6'>
                            <label class="control-label">Jabatan <span class='text-danger'>*</span></label>
                            <select class='form-control FormInput select-seksi' name='Jabatan' id='Jabatan'></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Mutasi Status <span class='text-danger'>*</span></label>
                            <select class='form-control FormInput select-mutasi' name='MutasiStatus' id='MutasiStatus'>
                                <option value="">Pilih Mutasi Status</option>
